...
| 主挂件界面 | 设置中心 | 关于界面 | 更新界面 |
| :---: | :---: | :---: | :---: |
| ![主界面](docs/screenshots/main_widget.png) | ![设置中心](docs/screenshots/settings_panel.png) | ![关于界面](docs/screenshots/about_panel.png) | ![更新界面](docs/screenshots/update_panel.png) |
| _半透明磨砂质感，全屏自由拖动_ |  _精细化考勤与提醒配置_ | _“关于”页面的温情提示_ | _摸鱼组件升级，带变更日志一键更新_ |
